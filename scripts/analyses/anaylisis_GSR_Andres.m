...
amp_ind1 = max(data(51:100, :)) - mean(data(1:49, :));
amp_mean1 = mean(max(data(51:100, :)) - mean(data(1:49, :)))

% amp_ind1 = max(data(51:100, :)) - mean(data(42:49, :));
% amp_mean1 = mean(max(data(51:100, :)) - mean(data(42:49, :)))

amp_cmp = repmat(amp_mean1, 1, 10000);
...
for i = 1:10000
    ...
    amp_res(1, i) = mean(max(vec_perm(51:100, :)) - mean(vec_perm(1:49, :)));
    % amp_res(1, i) = mean(max(vec_perm(51:100, :)) - mean(vec_perm(42:49, :)));
end

pv1 = sum(abs(amp_res) > amp_cmp, 2)/10000
...
amp_ind2 = max(data(51:100, :)) - mean(data(1:49, :));
amp_mean2 = mean(max(data(51:100, :)) - mean(data(1:49, :)))

% amp_ind2 = max(data(51:100, :)) - mean(data(42:49, :));
% amp_mean2 = mean(max(data(51:100, :)) - mean(data(42:49, :)))

amp_cmp = repmat(amp_mean2, 1, 10000);
amp_res = zeros(1, 10000);
...
pv2 = sum(abs(amp_res) > amp_cmp, 2)/10000
...
amp_ind3 = max(data(51:100, :)) - mean(data(1:49, :));
amp_mean3 = mean(max(data(51:100, :)) - mean(data(1:49, :)))

% amp_ind3 = max(data(51:100, :)) - mean(data(42:49, :));
% amp_mean3 = mean(max(data(51:100, :)) - mean(data(42:49, :)))

amp_cmp = repmat(amp_mean3, 1, 10000);
amp_res = zeros(1, 10000);
...
pv3 = sum(abs(amp_res) > amp_cmp, 2)/10000
...
amp_ind4 = max(data(51:100, :)) - mean(data(1:49, :));
amp_mean4 = mean(max(data(51:100, :)) - mean(data(1:49, :)))


% amp_ind4 = max(data(51:100, :)) - mean(data(42:49, :));
% amp_mean4 = mean(max(data(51:100, :)) - mean(data(42:49, :)))

amp_cmp = repmat(amp_mean4, 1, 10000);
amp_res = zeros(1, 10000);
...
pv4 = sum(abs(amp_res) > amp_cmp, 2)/10000
