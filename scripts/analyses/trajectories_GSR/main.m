...
%% OrderFile by vecUsed
order_trial = ...
    load('E:\GitHub\analysis-VR\data\03. Experiment_Rep\orderQuestionnaires');
sociodem = load('E:\GitHub\analysis-VR\data\03. Experiment_Rep\sociodem');
order_dyn = order_trial.orderArray([3:4,6], sociodem.vecUsed);


for i_subject = 1:1 %n_subjects
