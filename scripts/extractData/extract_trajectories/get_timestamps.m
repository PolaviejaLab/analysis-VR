function [ind_timestamps, timestamps_array] = get_timestamps ...
...
for t = 1:length(ind_timestamps)
    timestamps_array = vertcat(timestamps_array, ...
        TransformToMiliseconds(ts_col(ind_timestamps(t), :))); 
end
