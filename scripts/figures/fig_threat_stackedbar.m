...
value0_nonoise_nooffset = sum(vec_nonoise_nooffset == 0)/nSubjects;
value1_nonoise_nooffset = sum(vec_nonoise_nooffset == 1)/nSubjects;
value2_nonoise_nooffset = sum(vec_nonoise_nooffset == 2)/nSubjects;

value0_noise_nooffset = sum(vec_noise_nooffset == 0)/nSubjects;
value1_noise_nooffset = sum(vec_noise_nooffset == 1)/nSubjects;
value2_noise_nooffset = sum(vec_noise_nooffset == 2)/nSubjects;

value0_nonoise_offset = sum(vec_nonoise_offset == 0)/nSubjects;
value1_nonoise_offset = sum(vec_nonoise_offset == 1)/nSubjects;
value2_nonoise_offset = sum(vec_nonoise_offset == 2)/nSubjects;
