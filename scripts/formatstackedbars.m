...
for y = [0 conditions + 1]
    text(text_x, y + 0.85, 'Continuous limb', 'FontSize', 16, 'FontWeight', 'Bold');
    text(text_x, y + 1.19, 'No offset (0cm)', 'FontSize', 16, 'FontWeight', 'Bold');

    text(text_x, y + 1.85, 'Continuous limb', 'FontSize', 16, 'FontWeight', 'Bold');
    text(text_x, y + 2.19, 'Offset (10cm)', 'FontSize', 16, 'FontWeight', 'Bold');

    text(text_x, y + 2.85, 'Discontinuous limb', 'FontSize', 16, 'FontWeight', 'Bold');
    text(text_x, y + 3.19, 'Offset (0cm)', 'FontSize', 16, 'FontWeight', 'Bold');
    
    text(text_x, y + 3.85, 'Discontinuous limb', 'FontSize', 16, 'FontWeight', 'Bold');
    text(text_x, y + 4.19, 'Offset (10cm)', 'FontSize', 16, 'FontWeight', 'Bold');
end
