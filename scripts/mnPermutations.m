[owMeans, owcontMeans, agMeans, owSTD, owcontSTD, agSTD] = findmeans ();
...
% arrays with p-vals
pvals_mean_ownership = sum(owResMatrix >= owCompMatrix,2)/10000;
owcontMnPVals = sum(owcontResMatrix >= owcontCompMatrix,2)/10000;
pvals_mean_agency = sum(agResMatrix >= agCompMatrix,2)/10000;
